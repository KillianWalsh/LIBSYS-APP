...
function showBooking(){
  ...
  document.getElementById("TitleText").innerHTML = "Choose your room:"
}

function showCancel(){
  document.getElementById("DecisionDiv").style.display= "none";
  document.getElementById("CancelDiv").style.display= "block";
  document.getElementById("TitleText").innerHTML = "Insert your User ID"
}
...
function backToBeginning(){
  ...
  document.getElementById("TitleText").innerHTML = "What do you want to do?"
...
function setRoomNumber(number){
    ...
    document.getElementById("TitleText").innerHTML = "Choose your day:"
